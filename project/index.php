                ...
                <div class="keys-1__wrapper">
                    <div class="keys-1__picture">
                        ...
                        <div class=" field--name-field-blog-img field--type-image  ">    <picture>
                            <img width="840" height="475" src="src/articles/article1.png" alt="Data cache" typeof="foaf:Image">
                ...
                <div class="keys-2__wrapper">
                    <div class="keys-2__picture">
                        ...
                        <div class=" field--name-field-blog-img field--type-image  ">
                            <picture>
                                <img loading="eager" sizes="max-width:767px" width="700" height="360" src="src/articles/article2.png" alt="Ecommerce metrics" typeof="foaf:Image">
                            </picture>
                        </div>
            ...
            <article class="blog is-promoted keys-1 clear">
                <div class="keys-1__wrapper">
                    <div class="keys-1__picture">
                        ...
                        <div class=" field--name-field-blog-img field--type-image  ">    <picture>
                            <img loading="eager" width="840" height="475" src="src/articles/article3.png" alt="Conversion Improvement" typeof="foaf:Image">
            ...
            <article class="blog is-promoted keys-1 clear">
                <div class="keys-1__wrapper">
                    <div class="keys-1__picture">
                        ...
                        <div class=" field--name-field-blog-img field--type-image  ">    <picture>
                            <img loading="eager" width="840" height="475" src="src/articles/article4.png" alt="Drupal 7 acceleration" typeof="foaf:Image">
                        </picture>
            ...
            <article class="blog is-promoted keys-1 clear">
                <div class="keys-1__wrapper">
                    <div class="keys-1__picture">
                        ...
                        <div class=" field--name-field-blog-img field--type-image  ">    <picture>
                            <img loading="eager" width="840" height="475" src="src/articles/article1.png" alt="business-online" typeof="foaf:Image">
        ...
        <div class="view-content" >
            ...
            <div  id="slick-review">
                <div class="" >
                    <div class="views-field-field-project-logo">
                        <div class="field-content">
                            <img src="src/img/logo.png" width="113" height="46" alt="Ciel parfum" typeof="foaf:Image">
                        </div>
                    </div>
                ...
                <div class="" >
                    <div class="views-field-field-project-logo">
                        <div class="field-content">
                            <img src="src/img/logo_2.png" width="165" height="46" alt="Ciel parfum" typeof="foaf:Image">
                        </div>
                    </div>
                    <div class="views-field views-field-field-report-text">
                        <div class="field-content">
...
<section id="block-faq" class="dc-section faq-block block block-block-content clearfix">
    ...
    <h2 class="block-title faq-title">Вопрос/Ответ</h2>
            ...
            <div  class="panel-group panel-faq" id="accordion">
                ...
                <div class="panel panel-default panel_open">
                    ...
                    <div class="panel-body" >
                        Сайты обслуживаются штатными сотрудниками ООО «Инитлаб» из Краснодара, которые прошли специальное обучение и имеют опыт работы с Друпал от 4 до 15 лет. В команде 8 веб-разработчиков, 2 специалиста по SEO и 4 системных администратора.
                    </div>
                </div>
    ...
    <!-- Контейнер формы и отображение ошибок -->
